...
def live_application(capture, output_dirpath):
  ...
  # np.save('/home/renat/Desktop/mh_verts.npy', hand_mesh.verts)
  mesh.vertices = \
  ...
  while True:
    ...
    frame_large = io.imread('/home/renat/Desktop/555/left_in.png')[:, :, :3]
    # frame_large = io.imread('/home/renat/Desktop/555/right_in.png')[:, :, :3]
    ...
    # theta_mano = np.load('/home/renat/Desktop/fit.npy')
    # theta_mano = np.load('/home/renat/Desktop/quats.npy')

    v = hand_mesh.set_abs_quat(theta_mano)
    # v = np.load('/home/renat/Desktop/left.npy')
    v *= 2  # for better visualization
    v = v * 1000 + np.array([0, 0, 400])
    # v = v * 0.5 + np.array([0, 0, 400])
...
if __name__ == '__main__':
  fn_no_ext = '10_5300'
  input_video_filepath = f'/home/renat/workdir/data/kinect_pose_fitting/kinect_hands/test_hand_models/inputs/{fn_no_ext}.mp4'
  output_dirpath = f'/home/renat/workdir/data/kinect_pose_fitting/kinect_hands/test_hand_models/minimal_hand/output2/{fn_no_ext}'
  os.makedirs(output_dirpath, exist_ok=True)
  live_application(OpenCVCapture(input_video_filepath), output_dirpath)
